...
// 지역별 상점 목록 => 127.0.0.1:3000/api/bakery/storelist.json?page=1&text=검색어
// router.get('/storelist.json', async function (req,res,next) {
//   try{
//     const text = req.query.text; //검색어
//     const page = req.query.page; //1
    
//     //전체 데이터에서 제목이 검색어가 포함된 것 가져오기
//     //a => a123 => a라는 데이터를 찾으면 a123이라는 데이터중 a가 포함되어 있어서 불러 올 수 있게함
...
//     return res.send({ state: 200, total: total, result: result });
//   } catch(e) {
//     console.error(e);
//     return res.send({ status: -1, result: e});
//   }
